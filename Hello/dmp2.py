...
def Fileop(File1,File2):
    df1 = pd.read_excel(File1, na_values=['NA'])

    df2 = pd.read_excel(File2, na_values=['NA'])
...
Fileop("d:/report/DMP Execution suite.xlsx","d:/report/DMP Execution suite1.xlsx")